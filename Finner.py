...
def main():
    ...
    centered_and_rounded_image = f'<div style="display: flex; justify-content: center;"><img src="{image_url}" style="border-radius: 10px;" /></div>'
    st.markdown(centered_and_rounded_image, unsafe_allow_html=True)
